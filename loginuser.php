...
<body>
   ...
   <div class="container">
      <div class="text-center mb-4">
         <h3 style="color: white; font-weight: bold;">WELCOME LIBRARIAN</h3>
      </div>
      ...
      <div class="container d-flex justify-content-center">
         <form action="" method="post" style="width:50vw; min-width:300px;">
            ...
            <div>
               ...
               <span style="color: white; font-weight: bold;"><br><br>Don't have an account?</span><br>
               <a href="signupuser.php" class="btn btn-danger">Register Here</a>
            </div>
         </form>
      </div>
   </div>

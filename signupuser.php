...
<body>
   ...
   <div class="container">
      <div class="text-center mb-4">
         <h3 style="color: white; font-weight: bold;">USER SIGN UP</h3>
      </div>
      ...
      <?php if (isset($registrationSuccess)): ?>
         <p style="color: white;">Registration successful! You can login as a user now.</p>
      <?php endif; ?>
      ...
      <div class="container d-flex justify-content-center">
         <form action="" method="post" style="width:50vw; min-width:300px;">
            ...
            <div>
               ...
               <a href="loginuser.php" class="btn btn-dark mb-3">Back</a>
            </div>
         </form>
      </div>
   </div>
